...
setup_args = {
    ...
    'version': '0.1.0',
    'description': 'NWB extension for SWAC project in Harvey Lab',
    'long_description': readme,
    'long_description_content_type': readme_type,
    'author': 'Shih-Yi Tseng',
    'author_email': 'shihyitseng41@gmail.com',
    'url': '',
    'license': 'MIT',
    'install_requires': [
        'pynwb>=1.5.0,<3',
    ...
    'package_data': {'ndx_harvey_swac': [
        'spec/ndx-harvey-swac.namespace.yaml',
        'spec/ndx-harvey-swac.extensions.yaml',
    ]},
    'classifiers': [
